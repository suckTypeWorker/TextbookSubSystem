...
<br>
<br>
<h4 align="center">编辑教材${textbook.bookName}</h4>
<br>
        ...
        <div class="form-group col-xs-12">
            ...
            <div class="col-xs-4 col-md-2">
                <input type="email" class="form-control col-md-3 col-xs-3" id="ser" name="seriesName"
                       placeholder="${textbook.seriesName}">
            </div>
        </div>
        ...
        <div class="form-group col-xs-12">
            ...
            <div class="col-xs-4 col-md-2">
                <input type="email" class="form-control col-md-3 col-xs-3" id="date" name="publishDate"
                       placeholder="${textbook.publishDate}">
            </div>
        </div
        ...
        <div class="form-group col-xs-12">
            ...
            <div class="col-xs-4 col-md-2">
                <input type="email" class="form-control col-md-3 col-xs-3" id="classi" name="classification"
                       placeholder="${textbook.classification}">
            </div>
        </div>
        ...
        <div class="form-group col-xs-12">
            ...
            <div class="col-xs-4 col-md-2">
                <input type="email" class="form-control col-md-3 col-xs-3" id="theme" name="theme"
                       placeholder="${textbook.theme}">
            </div>
        </div>
        <%--<td><input type="text" name="theme" value="${textbook.theme}"/></td>--%>
        <div class="container-fluid">
            <div align="center">
                <button class="btn bg-success" onclick="updateTextbook()">保存</button>
            </div>
        </div>
    </div>
...
<%--<form id="bookForm">
    <table>
        ...
        <tr>
            <td>书籍名称</td>
            <td><input type="text" name="bookName" value="${textbook.bookName}"/></td>
        </tr>
        <tr>
           <td>ISBN号</td>
            <td><input type="text" name="ISBNId" value="${textbook.ISBNId}"/></td>
...
<script>
    function updateTextbook(){
        $.ajax({
            url:"<%=path%>/system/updateTextbook",
            type:"post",
