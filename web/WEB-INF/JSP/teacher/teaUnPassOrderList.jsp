    ...
    <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
            <ul>
                ...
                <li><a href="<%=path%>/system/teaPassedOrderList?userName=${user.userName}">
                    <i class="fa fa-bar-chart fa-fw"></i>已通过订单</a>
                </li>
                <li><a href="<%=path%>/system/teaUnPassOrderList?userName=${user.userName}">
                    <i class="fa fa-bar-chart fa-fw"></i>未通过订单</a>
                </li>
                <li><a href="<%=path%>/system/teacherAddOrder?userName=${user.userName}">
                    <i class="fa fa-bar-chart fa-fw"></i>添加订单</a>
                </li>
                <li>
            ...
            <div class="templatemo-flex-row flex-content-row">
                <div class="templatemo-content-widget white-bg col-2">
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach var="unpassOrder" items="${unpassList}">
                            <tr>
                                <td>${unpassOrder.textBook.bookName}</td>
                                <td>${unpassOrder.orderClass}</td>
                                <td>${unpassOrder.num}</td>
                                <td>${unpassOrder.sumPrice}</td>
                                <td><input class="btn bg-primary" onclick="editMyOrder(${unpassOrder.id})"
                                           value="修改订单"/></td>
                            </tr>
                        </c:forEach>
                    </table>
...
<script>
    ...
    function editMyOrder(id) {
        location.href = "<%=path%>/system/teacherEditOrder?id=" + id + "&userId=${user.userId}";
    }
