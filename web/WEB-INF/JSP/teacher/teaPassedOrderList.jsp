            ...
            <div class="templatemo-flex-row flex-content-row">
                <div class="templatemo-content-widget white-bg col-2">
                    ...
                    <table class="table table-striped">
                        ...
                        <c:forEach var="passOrder" items="${passList}">
                            <tr>
                                <td>${passOrder.textBook.bookName}</td>
                                <td>${passOrder.orderClass}</td>
                                <td>${passOrder.num}</td>
                                <td>${passOrder.sumPrice}</td>
                            </tr>
                        </c:forEach>
                    </table>
                </div>
...
<%--
                ...
                <li class="active"><a href="<%=path%>/system/teaPassedOrderList?userName=${user.userName}">已通过订单</a></li>
                <li><a href="<%=path%>/system/teaUnPassOrderList?userName=${user.userName}">未通过订单</a></li>
--%>
